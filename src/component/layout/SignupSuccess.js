    ...
    <div className="bg-gray-100">
      <div className="flex justify-center items-center h-screen">
        <div className="text-center my-auto">
          ...
          <p className="font-light">Your Signup succed, wait 5s you will redirect to login</p>
          <div className="flex justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" className="animate-spin h-20 mt-10">
